...
public class TransferFundsPage extends PageObject {
    public static final Target TRANSFER_FUNDS_LINK = Target.the("Transfer Funds link").locatedBy("//a[contains(text(),'Transfer Funds')]");
    ...
    public static final Target TRANSFER_BUTTON = Target.the("Transfer button").locatedBy("//input[@type='submit'][@value='Transfer']");
    public static final Target CONFIRMATION_MESSAGE = Target.the("Transfer confirmation message").locatedBy("//*[@id='showResult']/h1[@class='title']");
}
